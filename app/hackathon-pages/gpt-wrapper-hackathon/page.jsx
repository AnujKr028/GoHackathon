        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <ul>
                <li className='text-[11px] font-semibold text-gray-800'>Team lunar: need 1 frontend dev</li>
                <li className='text-[11px] font-semibold text-gray-800'>Team lokis: need 1 backend dev, 1 ml dev</li>
              </ul>
            </div>
          </div>
        </div>
