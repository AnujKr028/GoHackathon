...
//   return (
//     <div className="font-mono w-full max-w-6xl mx-auto p-4 sm:p-6 bg-white text-black">
//       {showNotification && (
...
//         <h1 className="text-3xl sm:text-4xl font-bold mb-3 text-gray-800 font-serif">Gpt Wrapper</h1>
//         <p className="text-xs sm:text-sm font-mono">Pushing the boundaries of innovation</p>
//       </div>

//       <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
//         <div className="lg:col-span-2">
//           <h2 className="text-lg sm:text-xl font-mono mb-4 border-b pb-2 text-sky-800">about the hackathon</h2>
//           <p className="mb-4 text-[11px] md:text-sm">Nights 2025 is the premier hackathon for developers, designers, and innovators. Join us for 48 hours of 
...
//           <p className="mb-4 text-[11px] md:text-sm">Whether you're a seasoned developer or just starting your tech journey, TechInnovate welcomes participants 
...
//           <p className="mb-4 text-[11px] md:text-sm">All projects will be judged based on innovation, technical complexity, user experience, and potential impact.
...
//           <h2 className="text-base sm:text-lg mb-4 border-b pb-2 text-sky-800">event details</h2>
//           <div className="space-y-3 sm:space-y-4">
//             <div><p className="text-[12px] text-sky-800">Start Date:</p><p className='text-[11px] md:text-sm font-semibold text-gray-800'>June 15, 2025 - 10:00 AM</p></div>
//             <div><p className="text-[12px] text-sky-800">End Date:</p><p className='text-[11px] md:text-sm font-semibold text-gray-800'>June 17, 2025 - 4:00 PM</p></div>
//             <div><p className="text-[12px] text-sky-800">Location:</p><p className='text-[11px] md:text-sm font-semibold text-gray-800'>Tech Innovation Hub</p></div>
//             <div><p className="text-[12px] text-sky-800">Participants:</p><p className='text-[11px] md:text-sm font-semibold text-gray-800'>Limited to 200 participants</p></div>
//             <div><p className="text-[12px] text-sky-800">Prize Pool:</p><p className='text-[11px] md:text-sm font-semibold text-gray-800'>$25,000 in cash and prizes</p></div>
//             <div>
//               <p className="text-[12px] text-sky-800">positions opened</p>
//               <ul className="pl-4">
//                 <li className='text-[11px] md:text-sm font-semibold text-gray-800'>Team lunar: need 1 frontend dev</li>
//                 <li className='text-[11px] md:text-sm font-semibold text-gray-800'>Team lokis: need 1 backend dev, 1 ml dev</li>
//               </ul>
//             </div>
//           </div>
//         </div>
...
//       <div className="bg-white p-4 sm:p-8 rounded-2xl mb-12 shadow-xl border border-gray-200 w-full mx-auto font-mono">
//         <h2 className="text-base sm:text-lg mb-6 text-center text-gray-800">make your team</h2>
//         <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 max-w-md mx-auto">
//           <div>
//             <label className="block mb-1 text-xs sm:text-sm text-gray-900" htmlFor="name">participant name</label>
//             <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-800 transition placeholder:text-xs sm:placeholder:text-sm" required placeholder='enter your full name' />
//           </div>

//           <div>
//             <label className="block mb-1 text-xs sm:text-sm text-gray-900" htmlFor="role">your role</label>
//             <select id="role" name="role" value={formData.role} onChange={handleChange} className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-800 transition text-xs sm:text-sm text-gray-900" required>
...
//           <div>
//             <label className="block mb-1 text-xs sm:text-sm text-gray-900" htmlFor="team">team</label>
//             <input type="text" id="team" name="team" value={formData.team} onChange={handleChange} className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-800 transition placeholder:text-xs sm:placeholder:text-sm" required placeholder='enter the team you want to join' />
//           </div>

//           <div>
//             <label className="block mb-1 text-xs sm:text-sm text-gray-900" htmlFor="email">email address</label>
//             <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-800 transition placeholder:text-xs sm:placeholder:text-sm" required placeholder='enter your email' />
//           </div>
...
//         <h2 className="text-xl sm:text-2xl font-mono text-center mb-6 font-normal text-sky-800 tracking-wide">Important Information</h2>
//         <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
//           <div className="bg-gray-50 p-4 sm:p-6 rounded-lg h-full">
//             <h3 className="text-base sm:text-lg font-mono text-center mb-4 font-normal text-sky-800 lowercase tracking-wide">Schedule</h3>
//             <ul className="space-y-2 text-gray-900 font-mono text-xs sm:text-sm">
...
//           </div>
//           <div className="bg-gray-50 p-4 sm:p-6 rounded-lg h-full">
//             <h3 className="text-base sm:text-lg font-mono text-center mb-4 font-normal text-sky-800 lowercase tracking-wide">What to Bring</h3>
//             <ul className="space-y-2 text-gray-900 font-mono text-xs sm:text-sm">
...
const HackathonPage = () => {
  ...
  return (
    <div className="font-mono w-full max-w-6xl mx-auto p-4 sm:p-6 bg-white text-black text-sm md:text-base lg:text-lg">
      ...
      <div className="mb-6 md:mb-10 text-center">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-3 text-gray-800 font-serif">Gpt Wrapper</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
        <div className="lg:col-span-2">
          ...
          <p className="mb-4 text-[11px] sm:text-sm lg:text-base">Gpt Wrapper 2025 is the premier hackathon for developers, designers, and innovators. Join us for 48 hours of 
             coding, collaboration, and creativity as you build solutions to real-world problems. This year's focus is on 
            sustainable technology and AI solutions that can help address climate challenges.</p>
        ...
        <div className="bg-gray-50 p-4 sm:p-6 rounded-lg h-full">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div>
              ...
              <ul className="pl-4">
                <li className='text-[11px] sm:text-sm lg:text-base font-semibold text-gray-800'>Team lunar: need 1 frontend dev</li>
                <li className='text-[11px] sm:text-sm lg:text-base font-semibold text-gray-800'>Team lokis: need 1 backend dev, 1 ml dev</li>
              </ul>
            </div>
          </div>
        </div>
